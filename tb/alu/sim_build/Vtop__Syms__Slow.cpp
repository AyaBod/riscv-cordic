    ...
    , TOP{this, namep}
{
    ...
    __Vscopep_TOP->varInsert("alu_op", &(TOP.alu_op), false, VLVT_UINT8, VLVD_IN|VLVF_PUB_RW, 0, 1 ,3,0);
    ...
    __Vscopep_alu->varInsert("alu_op", &(TOP.alu__DOT__alu_op), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,3,0);
    __Vscopep_alu->varInsert("operand_a", &(TOP.alu__DOT__operand_a), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,31,0);
    __Vscopep_alu->varInsert("operand_b", &(TOP.alu__DOT__operand_b), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,31,0);
